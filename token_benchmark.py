...
for max_tokens in TOKEN_TESTS:
    ...
    print()
    print("=" * 50)
    print("Testing max_tokens =", max_tokens)
    print("=" * 50)
...
filename = f"token_benchmark_{timestamp}.csv"
